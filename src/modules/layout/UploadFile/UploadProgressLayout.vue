<template>
   <div class="text-black w-full mobile min-h-screen">
      <ButtonGlobal :class="['fixed left-1 p-4 text-white', isMobile ? 'bottom-1': 'hidden top-1 ']" style="border-radius: 50%;" value="" @click="back">
         <template #icon-right>
            <el-icon>
               <ArrowLeftBold />
            </el-icon>
